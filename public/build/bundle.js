...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	card = new Card({
    			props: {
    				temp: /*$currentWeather*/ ctx[1].current.temp_c,
    				conditionText: /*$currentWeather*/ ctx[1].current.condition.text,
    				locationName: /*$currentWeather*/ ctx[1].location.name,
    				humidity: /*$currentWeather*/ ctx[1].current.humidity,
    				wind: /*$currentWeather*/ ctx[1].current.wind_kph,
    				uv: /*$currentWeather*/ ctx[1].current.uv,
    				conditionTextIcon: /*conditionTextIcon*/ ctx[6],
    				dayName: /*dayName*/ ctx[2],
    				month: /*month*/ ctx[4],
    				hours: /*hours*/ ctx[0],
    				minutes: /*minutes*/ ctx[5],
    				dayNumber: /*dayNumber*/ ctx[3]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*$currentWeather*/ 2) card_changes.temp = /*$currentWeather*/ ctx[1].current.temp_c;
    			if (dirty & /*$currentWeather*/ 2) card_changes.conditionText = /*$currentWeather*/ ctx[1].current.condition.text;
    			if (dirty & /*$currentWeather*/ 2) card_changes.locationName = /*$currentWeather*/ ctx[1].location.name;
    			if (dirty & /*$currentWeather*/ 2) card_changes.humidity = /*$currentWeather*/ ctx[1].current.humidity;
    			if (dirty & /*$currentWeather*/ 2) card_changes.wind = /*$currentWeather*/ ctx[1].current.wind_kph;
    			if (dirty & /*$currentWeather*/ 2) card_changes.uv = /*$currentWeather*/ ctx[1].current.uv;
    			if (dirty & /*conditionTextIcon*/ 64) card_changes.conditionTextIcon = /*conditionTextIcon*/ ctx[6];
    			if (dirty & /*dayName*/ 4) card_changes.dayName = /*dayName*/ ctx[2];
    			if (dirty & /*month*/ 16) card_changes.month = /*month*/ ctx[4];
    			if (dirty & /*hours*/ 1) card_changes.hours = /*hours*/ ctx[0];
    			if (dirty & /*minutes*/ 32) card_changes.minutes = /*minutes*/ ctx[5];
    			if (dirty & /*dayNumber*/ 8) card_changes.dayNumber = /*dayNumber*/ ctx[3];
    ...
    function create_fragment$2(ctx) {
    	let main;
    	let current;
    	let if_block = /*$currentWeather*/ ctx[1] !== null && create_if_block$1(ctx);

    	const block = {
    		c: function create() {
    			main = element("main");
    			if (if_block) if_block.c();
    			add_location(main, file$2, 33, 0, 1072);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*$currentWeather*/ ctx[1] !== null) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*$currentWeather*/ 2) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $currentWeather;
    	validate_store(currentWeather, "currentWeather");
    	component_subscribe($$self, currentWeather, $$value => $$invalidate(1, $currentWeather = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<CurrentWeatherDay> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("dayName" in $$props) $$invalidate(2, dayName = $$props.dayName);
    		if ("dayNumber" in $$props) $$invalidate(3, dayNumber = $$props.dayNumber);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$currentWeather, hours*/ 3) {
    			 if ($currentWeather !== null) {
    				$$invalidate(6, conditionTextIcon = getIconsCard($currentWeather.current.is_day, $currentWeather.current.condition.text));
    				$$invalidate(3, dayNumber = new Date($currentWeather.location.localtime).getDate());
    				const selectMonth = new Date($currentWeather.location.localtime).getMonth();
    				$$invalidate(4, month = MONTH[selectMonth].name);
    				const selectDay = new Date($currentWeather.location.localtime).getDay();
    				$$invalidate(2, dayName = DAYS[selectDay].name);
    				$$invalidate(0, hours = new Date($currentWeather.location.localtime).getHours());
    	...
    	return [hours, $currentWeather, dayName, dayNumber, month, minutes, conditionTextIcon];
    }
